...
const social = [
  { name: 'GitHub', icon: GitHubIcon, link: 'https://github.com/Monicaaawa' },
  { name: 'Instagram', icon: InstagramIcon, link: 'https://www.instagram.com/therealmonica_ye/' },
  { name: 'Personal Website', icon: WebIcon, link: 'https://monicaaawa.github.io/' },
];
...
export const Head = () => <title>Story of My Life</title>